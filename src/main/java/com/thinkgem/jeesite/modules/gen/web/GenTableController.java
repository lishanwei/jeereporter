...
public class GenTableController extends BaseController {
    ...
    public String getDBName(GenTable genTable, Model model) {

        model.addAttribute("dbInfoList", DataSourceContextHolder.dbInfoList);
	...
	public String form(GenTable genTable, Model model) {
        ...
        DataSourceContextHolder.setDbTarget(genTable.getDbkeyName());
		...
		// 获取物理表字段
            ...
            if (!StringUtils.isEmpty(genTable.getRemarks())) {
                genTable.setDbkeyName(genTable.getRemarks());
                DataSourceContextHolder.setDbTarget(genTable.getDbkeyName());
                genTable = genTableService.getTableFormDb(genTable);
            }
		}
	...
	public String save(GenTable genTable, Model model, RedirectAttributes redirectAttributes) {
        ...
        genTable.setRemarks(genTable.getDbkeyName());
