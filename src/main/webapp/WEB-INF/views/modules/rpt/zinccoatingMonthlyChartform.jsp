...
<body>
	<form:form id="searchForm" modelAttribute="zinccoatingMonthlyReport" action="${ctx}/rpt/zinccoatingMonthlyReport/chartform" method="post" class="breadcrumb form-search">
...
<script type="text/javascript">
    ...
    function loadChartData() {
        ...
        $.getJSON('${ctx}/jechart/monthly/queryEchartOptionData?now='+now, params, function (data) {
            if (data.success) {
