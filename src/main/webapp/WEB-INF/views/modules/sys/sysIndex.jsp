	...
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				...
				<ul id="userControl" class="nav pull-right">
					...
					<li id="userInfo">
                        <%--<a href="#" title="个人信息">您好, ${fns:getUser().name}&nbsp;</a>--%>
						...
						<ul class="dropdown-menu">
							...
							<li><a href="${ctx}/auth/authUser/modifyPwd" target="mainFrame"><i class="icon-lock"></i>&nbsp;  修改密码</a></li>
	    ...
	    <div class="container-fluid">
			<div id="content" class="row-fluid">
                ...
                <div id="scrollee" style="-webkit-overflow-scrolling:touch; overflow: auto;">
				<div id="right">
