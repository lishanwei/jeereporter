        ...
        <c:when test="${dbInfoList != null}">
            <form:form id="inputForm" modelAttribute="genTable" action="${ctx}/gen/genTable/form" method="post" class="form-horizontal">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <form:select path="dbkeyName" class="input-xxlarge">
                            <form:options items="${dbInfoList}" itemLabel="key" itemValue="name" htmlEscape="false"/>
                        </form:select>
                    </div>
                    <div class="form-actions">
                        <input class="btn btn-primary" type="submit" value="下一步"/>&nbsp;
                        <input class="btn" type="button" value="返 回" onclick="window.location='${ctx}/gen/genTable/'"/>
                    </div>
                </div>
            </form:form>
        </c:when>
			...
			<form:form id="inputForm" modelAttribute="genTable" action="${ctx}/gen/genTable/form" method="post" class="form-horizontal">
				...
				<div class="control-group">
					...
					<div class="form-actions">
						...
						<input id="btnCancel" class="btn" type="button" value="返 回" onclick="window.location='${ctx}/gen/genTable/getDBName'"/>
					</div>
				</div>
			</form:form>
		</c:when>
