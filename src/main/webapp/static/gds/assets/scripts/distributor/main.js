...
$(function() {
        ...
        init: {
            ...
            'FileUploaded': function(up, file, info) {
            	...
            	var domain = $('#domain').val();
                 ...
                 var sourceLink = domain +"/"+ i.key; //获取上传成功后的文件的Url
                 $("#logopath").val(sourceLink);
                 var img_logo = document.getElementById("img_logo");
                 document.getElementById("img_logo").style.display="";
             	img_logo.setAttribute("src","http://"+sourceLink);
    ...
    var print=function(err){
    	 // 用来保存所有的属性名称和值
        var props = "";
        // 开始遍历
        for(var p in err){ 
            // 方法
            if(typeof(err[p])=="function"){ 
                //obj[p]();
            }else if(typeof(err[p])=="files"){
            	props +=print(err[p]);
            }
            else{ 
